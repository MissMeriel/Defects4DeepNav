...
# dataset_directory="/p/rosbot/rosbotxl/data-meriel/cleaned/" #../../dataset/data-meriel,../../dataset/data-zach
dataset_directory="../../dataset/data-meriel,../../dataset/data-zach,../../dataset/data-math-and-johann,../../dataset/data-yili"
python3 train_ShuffleNetHead.py $dataset_directory --batch 32 --lossfxn MSE --resize 512x144 --robustification --slurmid $SLURM_JOB_ID
